...
const Contact = () => {
  ...
  return (
    <section id="contact" className="contact py-48  ">
      ...
      {/* FORM & IMAGE */}
      <div className="md:flex md:justify-between gap-16 h-[250px]">
        <motion.div
          initial="hidden"
          whileInView="visible"
          viewport={{ once: true, amount: 0.5 }}
        ...
        >
          <img src={require("../assets/contact-me.jpg")} alt="contact" />
        </motion.div>
        ...
        >
          ...
          >
            ...
            <button
              className="p-2 bg-blue font-semibold text-deep-blue mb-15 mt-5 hover:bg-red hover:text-white transition duration-500"
              type="submit"
            >
              SEND ME A MESSAGE
            </button>
