    ...
    <section id="skills" className="pt-{-1} pb-24">
      ...
      <div className="md:flex md:justify-between mt-6 gap-32">
        ...
        >
          ...
          <p className="mt-25 mb-32">
          As a front-end developer, I try to make a seamless web app that helps users accomplish what they need with major focus on ReactJS.
          </p>
        </motion.div>
        {/* IMAGINATIVE */}
        <motion.div
        ...
        >
          ...
          <p className="mt-25 mb-32 ">
          Eager to acquire hands over a new technology including convolutional neural networks.
          </p>
        </motion.div>
      </div>
